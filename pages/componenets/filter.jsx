...
export default function Filter() {
    ...
    return (
        ...
        <div className={'lg:col-span-4 sm:col-span-6 col grid grid-cols-3 gap-4'}>
            <div className={'flex'}>
                <div className={'w-4 h-1 border-b-2 border-red-700 pt-4 mr-2 active'}></div>
                <strong >{'All'}</strong>
            </div>
        ...
        <div className={'lg:col-span-2  lg:visible md:visible sm:invisible invisible flex items-end lg:justify-end md:pt-10'}>
            ...
            <div className={"category col-span-4 grid grid-cols-2 gap-x-10 gap-y-5 pt-3 mt-2 px-5 border-l border-black"}>
                <div className={'text-xs'}>
                    <img  className={'inline mr-3'} src="https://www.codigo.co/img/ui/ico-app.svg" width={12}/> 
                    <p className={'inline font-light'} >APP</p>
                </div>
                <div className={'text-xs'}>
                    <img  className={'inline mr-3'} src="https://www.codigo.co/img/ui/ico-web.svg" width={12}/> 
                    <p className={'inline font-light'} >WEB</p>
                </div>
                <div className={'text-xs'}>
                    <img  className={'inline mr-3'} src="https://www.codigo.co/img/ui/ico-cms.svg" width={12}/> 
                    <p className={'inline font-light'} >CMS</p>
                </div>
                <div className={'text-xs'}>
                    <img  className={'inline mr-3'} src="https://www.codigo.co/img/ui/ico-uiux.svg" width={12}/> 
